# Agent Guide — ep_help_bubbles

Help bubbles for Etherpad Lite.
...
`ep_help_bubbles` runs inside Etherpad's test harness. From an etherpad checkout that has installed this plugin via `pnpm run plugins i --path ../ep_help_bubbles`:
...
* Server: `eejsBlock_scripts`, `eejsBlock_styles`, `eejsBlock_editbarMenuRight`
